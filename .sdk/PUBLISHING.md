...
|---|---|---|
| `ts/` | @voxgig-sdk/sunset-times-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/sunset-times-sdk \
      --repository voxgig-sdk/sunset-times-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/sunset-times-sdk` shows it, and
`npm trust revoke @voxgig-sdk/sunset-times-sdk --id=<id>` removes it.
