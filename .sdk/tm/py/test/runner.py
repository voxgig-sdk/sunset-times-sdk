...
class SunsetTimesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SunsetTimesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SunsetTimesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SunsetTimesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
