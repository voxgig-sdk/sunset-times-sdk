...
class SunsetTimesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SunsetTimesTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = SunsetTimesTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = SunsetTimesTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
