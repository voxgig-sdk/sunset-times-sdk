...
class SunsetTimesRbacFeature extends SunsetTimesBaseFeature
{
    ...
    private function _required(SunsetTimesContext $ctx): ?string
    {
    ...
    private function _reject(SunsetTimesContext $ctx, string $required): void
    {
    ...
    private function _track(SunsetTimesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
