...
// SunsetTimes SDK clienttrack feature
...
class SunsetTimesClienttrackFeature extends SunsetTimesBaseFeature
{
    ...
    public function PostConstruct(SunsetTimesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SunsetTimes-SDK';
