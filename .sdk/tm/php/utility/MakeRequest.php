...
// SunsetTimes SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SunsetTimesMakeRequest
{
    public static function call(SunsetTimesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SunsetTimesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SunsetTimesResponse($fetched);
        } else {
