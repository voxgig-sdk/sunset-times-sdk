...
// SunsetTimes SDK utility: fetcher

class SunsetTimesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SunsetTimesSDK/1.0)';
    ...
    public static function call(SunsetTimesContext $ctx, string $fullurl, array $fetchdef): array
    {
