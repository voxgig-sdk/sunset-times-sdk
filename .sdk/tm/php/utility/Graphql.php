...
// SunsetTimes SDK utility: graphql
//
...
class SunsetTimesGraphql
{
    ...
    // equivalent.
    public static function body(SunsetTimesContext $ctx): mixed
    {
    ...
    public static function errors(SunsetTimesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
