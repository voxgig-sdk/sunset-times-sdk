...
// SunsetTimes SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SunsetTimesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SunsetTimesOmni::structfix($now, Struct::undef()))
                        !== json_encode(SunsetTimesOmni::structfix($val, Struct::undef()))) {
