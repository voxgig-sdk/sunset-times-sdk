...
{
    private static function utility(): SunsetTimesUtility
    {
        return new SunsetTimesUtility();
    }
    ...
    private static function ctx(array $over = []): SunsetTimesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SunsetTimesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SunsetTimesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SunsetTimesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SunsetTimesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SunsetTimesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SunsetTimesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SunsetTimesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SunsetTimesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SunsetTimesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SunsetTimesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SunsetTimesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SunsetTimesResponse([]),
            'result' => new SunsetTimesResult([]),
        ]);
        [, $err] = SunsetTimesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SunsetTimesSpec([]),
            'response' => null,
            'result' => new SunsetTimesResult([]),
        ]);
        [, $err] = SunsetTimesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SunsetTimesSpec(['step' => 's']),
            'response' => new SunsetTimesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SunsetTimesResult([]),
        ]);
        [, $err] = SunsetTimesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SunsetTimesSpec(['step' => 's']),
            'response' => new SunsetTimesResponse(self::resp(200, ['v' => 1])),
            'result' => new SunsetTimesResult([]),
        ]);
        [, $err] = SunsetTimesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SunsetTimesSpec(['step' => 's']),
            'response' => new SunsetTimesResponse(self::resp(200, ['v' => 2])),
            'result' => new SunsetTimesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SunsetTimesMakeResponse::call($ctx);
    ...
    {
        $preset = new SunsetTimesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SunsetTimesSpec([]),
            'response' => new SunsetTimesResponse([]),
            'result' => new SunsetTimesResult([]),
        ...
        [$got, $err] = SunsetTimesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SunsetTimesResult([])]);
        [, $err] = SunsetTimesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SunsetTimesSpec([]), 'result' => null]);
        [, $err] = SunsetTimesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SunsetTimesSpec(['step' => 's']),
            'result' => new SunsetTimesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SunsetTimesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SunsetTimesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SunsetTimesSpec(['step' => 's']),
            'result' => new SunsetTimesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SunsetTimesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SunsetTimesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SunsetTimesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SunsetTimesSpec([]),
            'result' => new SunsetTimesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SunsetTimesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SunsetTimesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SunsetTimesError('boom', 'boom');
        $utility->fetcher = function (SunsetTimesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SunsetTimesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SunsetTimesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SunsetTimesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SunsetTimesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SunsetTimesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SunsetTimesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SunsetTimesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SunsetTimesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SunsetTimesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SunsetTimesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SunsetTimesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SunsetTimesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SunsetTimesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SunsetTimesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SunsetTimesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SunsetTimesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SunsetTimesResult(['ok' => false])]);
        $this->expectException(SunsetTimesError::class);
        SunsetTimesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SunsetTimesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SunsetTimesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SunsetTimesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SunsetTimesBaseFeature();
        $b = new SunsetTimesBaseFeature();
        SunsetTimesFeatureAdd::call($ctx, $a);
        SunsetTimesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SunsetTimesBaseFeature
    {
        $f = new SunsetTimesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SunsetTimesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SunsetTimesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SunsetTimesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SunsetTimesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SunsetTimesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SunsetTimesResponse(['headers' => null]),
            'result' => new SunsetTimesResult([]),
        ]);
        SunsetTimesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        SunsetTimesResultBody::call($ctx);
