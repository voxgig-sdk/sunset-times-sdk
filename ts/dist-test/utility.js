...
function envOverride(m) {
    if ('TRUE' === process.env.SUNSET_TIMES_TEST_LIVE ||
        'TRUE' === process.env.SUNSET_TIMES_TEST_OVERRIDE) {
    ...
    m.SUNSET_TIMES_TEST_EXPLAIN = process.env.SUNSET_TIMES_TEST_EXPLAIN || m.SUNSET_TIMES_TEST_EXPLAIN;
    return m;
}
