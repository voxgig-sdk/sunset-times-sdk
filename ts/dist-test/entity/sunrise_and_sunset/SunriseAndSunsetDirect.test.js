...
(0, node_test_1.describe)('SunriseAndSunsetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SunsetTimesSDK({
    ...
    (0, node_test_1.test)('direct-load-sunrise_and_sunset', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-sunrise_and_sunset', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.SUNSET_TIMES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SunsetTimesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SUNSET_TIMES_TEST_SUNRISE_AND_SUNSET_ENTID'];
    ...
    const client = new __1.SunsetTimesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SunriseAndSunsetDirect.test.js.map