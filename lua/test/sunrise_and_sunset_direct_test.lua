...
describe("SunriseAndSunsetDirect", function()
  it("should direct-load-sunrise_and_sunset", function()
    local setup = sunrise_and_sunset_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-sunrise_and_sunset", setup.live and "live" or "unit")
...
function sunrise_and_sunset_direct_setup(mockres)
