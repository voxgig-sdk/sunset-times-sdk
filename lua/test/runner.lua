...
function runner.env_override(m)
  local live = runner.getenv("SUNSETTIMES_TEST_LIVE")
  local override = runner.getenv("SUNSETTIMES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SUNSETTIMES_TEST_EXPLAIN")
