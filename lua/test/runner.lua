...
function runner.env_override(m)
  local live = runner.getenv("SUNSET_TIMES_TEST_LIVE")
  local override = runner.getenv("SUNSET_TIMES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SUNSET_TIMES_TEST_EXPLAIN")
