...
local SunsetTimesSDK = {}
SunsetTimesSDK.__index = SunsetTimesSDK
...
SunsetTimesSDK._make_feature = _make_feature


function SunsetTimesSDK.new(options)
  local self = setmetatable({}, SunsetTimesSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function SunsetTimesSDK:options_map()
...
function SunsetTimesSDK:get_utility()
  return Utility.copy(self._utility)
end


function SunsetTimesSDK:get_root_ctx()
  return self._rootctx
end


function SunsetTimesSDK:prepare(fetchargs)
...
function SunsetTimesSDK:direct(fetchargs)
...
-- by passing it.
function SunsetTimesSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function SunsetTimesSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "SunsetTimesSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function SunsetTimesSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = SunsetTimesSDK.new(sdkopts)
  sdk.mode = "test"
