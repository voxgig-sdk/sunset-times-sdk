...
class SunriseAndSunsetEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set SUNSET_TIMES_TEST_SUNRISE_AND_SUNSET_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def sunrise_and_sunset_basic_setup(extra)
  ...
  entid_env_raw = ENV["SUNSET_TIMES_TEST_SUNRISE_AND_SUNSET_ENTID"]
