...
#      offline in seeded test mode (SunsetTimesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "SunsetTimes_sdk.rb")
  SDK_CLASS = "SunsetTimesSDK"
