...
class SunriseAndSunsetEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SUNSET_TIMES_TEST_SUNRISE_AND_SUNSET_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function sunrise_and_sunset_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SUNSET_TIMES_TEST_SUNRISE_AND_SUNSET_ENTID");
    ...
    if ($env["SUNSET_TIMES_TEST_LIVE"] === "TRUE") {
