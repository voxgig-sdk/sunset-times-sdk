...
// SunsetTimes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SunsetTimesSDK::test)
...
{
    private const SDK_CLASS = 'SunsetTimesSDK';
    ...
    private const SDK_BASE = 'sunsettimes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../sunsettimes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
