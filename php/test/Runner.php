...
class SunsetTimesTestRunner
{
    ...
    {
        $live = self::getenv('SUNSET_TIMES_TEST_LIVE');
        $override = self::getenv('SUNSET_TIMES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SUNSET_TIMES_TEST_EXPLAIN');
...
class_alias('SunsetTimesTestRunner', 'Runner');
class_alias('SunsetTimesHelpers', 'Helpers');
