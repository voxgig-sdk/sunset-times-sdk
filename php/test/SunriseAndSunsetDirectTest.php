...
class SunriseAndSunsetDirectTest extends TestCase
{
    public function test_direct_load_sunrise_and_sunset(): void
    {
        $setup = sunrise_and_sunset_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-sunrise_and_sunset", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
