...
// SunsetTimes SDK idempotency feature
...
class SunsetTimesIdempotencyFeature extends SunsetTimesBaseFeature
{
    ...
    private function _mutating(SunsetTimesContext $ctx): bool
    {
