...
// SunsetTimes SDK netsim feature
...
class SunsetTimesNetsimFeature extends SunsetTimesBaseFeature
{
    ...
    private function _simulate(SunsetTimesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SunsetTimesContext $ctx, array $applied): void
    {
        $client = $this->client;
