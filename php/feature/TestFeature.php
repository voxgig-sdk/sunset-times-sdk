...
// SunsetTimes SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SunsetTimesTestFeature extends SunsetTimesBaseFeature
{
    ...
    public function init(SunsetTimesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SunsetTimesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = SunsetTimesParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SunsetTimesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SunsetTimesContext $ctx, $op, $args): array
    {
