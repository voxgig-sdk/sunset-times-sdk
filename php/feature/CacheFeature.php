...
class SunsetTimesCacheFeature extends SunsetTimesBaseFeature
{
    ...
    private function _through(SunsetTimesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
