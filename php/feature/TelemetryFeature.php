...
// SunsetTimes SDK telemetry feature
...
class SunsetTimesTelemetryFeature extends SunsetTimesBaseFeature
{
    ...
    private function _close(SunsetTimesContext $ctx, bool $ok): void
    {
