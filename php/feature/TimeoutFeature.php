...
// SunsetTimes SDK timeout feature
...
class SunsetTimesTimeoutFeature extends SunsetTimesBaseFeature
{
    ...
    private function _with_timeout(SunsetTimesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SunsetTimesContext $_ctx, float $ms): void
    {
        $client = $this->client;
