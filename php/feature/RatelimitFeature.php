...
// SunsetTimes SDK ratelimit feature
...
class SunsetTimesRatelimitFeature extends SunsetTimesBaseFeature
{
    ...
    private function _acquire(SunsetTimesContext $ctx): void
    {
    ...
    private function _track(SunsetTimesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
