...
// SunsetTimes SDK streaming feature
...
class SunsetTimesStreamingFeature extends SunsetTimesBaseFeature
{
    ...
    private function _iterate(SunsetTimesResult $result): \Generator
    {
    ...
    private function _streamable(SunsetTimesContext $ctx): bool
    {
