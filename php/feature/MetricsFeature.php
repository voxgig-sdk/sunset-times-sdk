...
// SunsetTimes SDK metrics feature
...
class SunsetTimesMetricsFeature extends SunsetTimesBaseFeature
{
    ...
    private function _record(SunsetTimesContext $ctx, bool $ok): void
    {
