...
class SunsetTimesProxyFeature extends SunsetTimesBaseFeature
{
    ...
    public function init(SunsetTimesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SunsetTimesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
