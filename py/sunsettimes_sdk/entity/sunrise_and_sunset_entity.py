...
from sunsettimes_sdk.sunsettimes_types import (
    SunriseAndSunset,
...
class SunriseAndSunsetEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SunriseAndSunsetEntity(self._client, opts)
    ...
    def data_get(self) -> SunriseAndSunset:
    ...
    def match_get(self) -> SunriseAndSunset:
    ...
    def load(self, reqmatch=None, ctrl=None) -> SunriseAndSunset:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.SunriseAndSunset().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
