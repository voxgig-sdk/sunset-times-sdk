...
from sunsettimes_sdk.utility import register

# Load features
from sunsettimes_sdk.feature.base_feature import SunsetTimesBaseFeature
from sunsettimes_sdk.features import _has_feature, _make_feature
...
class SunsetTimesSDK:
    ...
    def get_utility(self):
        return SunsetTimesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SunsetTimesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def SunriseAndSunset(self, data=None) -> "SunriseAndSunsetEntity":
        ...
        from sunsettimes_sdk.entity.sunrise_and_sunset_entity import SunriseAndSunsetEntity
