...
from sunsettimes_sdk.core.helpers import get_ctx_prop, to_map
...
class SunsetTimesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, SunsetTimesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SunsetTimesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SunsetTimesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SunsetTimesError(code, msg, self)
