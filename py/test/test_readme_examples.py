# SunsetTimes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SunsetTimesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SunsetTimesSDK(...) and SunsetTimesSDK.test(...) become
#      SunsetTimesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "sunsettimes_sdk"
_SDK_CLASS = "SunsetTimesSDK"
...
_ENTITIES = {
    "SunriseAndSunset": "sunrise_and_sunset",
}
