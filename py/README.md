...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.SunriseAndSunset()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/sunset-times-sdk/releases)) or
