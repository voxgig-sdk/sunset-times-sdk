...
AQL-driven CLI and REPL for the SunsetTimes SDK. Positional arguments are
...
./sunset-times-cli list sunrise_and_sunset
./sunset-times-cli load 1 sunrise_and_sunset
./sunset-times-cli load '{id:1}' sunrise_and_sunset
