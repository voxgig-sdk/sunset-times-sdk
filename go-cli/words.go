...
func registerSDKWords(r *eng.Registry, client *sdk.SunsetTimesSDK) {
...
func runOp(client *sdk.SunsetTimesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
