...
type Args struct {
	Entity string         `json:"entity" jsonschema:"sunrise_and_sunset"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SunsetTimesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "sunset-times_list",
		Description: "List records from SunsetTimes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "sunset-times_load",
		Description: "Load a single record from SunsetTimes. " +
...
func runOp(client *sdk.SunsetTimesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SunsetTimesSDK, name string) (sdk.SunsetTimesEntity, error) {
	switch strings.ToLower(name) {
	case "sunrise_and_sunset":
		return client.SunriseAndSunset(nil), nil
