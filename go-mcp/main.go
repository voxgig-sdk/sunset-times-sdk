// Command SunsetTimes-mcp is an MCP server exposing the SunsetTimes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SunsetTimes_list  — list records of an entity
//	SunsetTimes_load  — load a single record of an entity
//
