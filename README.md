...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/sunset-times` | `npm install @voxgig-sdk/sunset-times` |
| Python | `voxgig-sdk-sunset-times` | `pip install voxgig-sdk-sunset-times` |
| PHP | `voxgig-sdk/sunset-times` | `composer require voxgig-sdk/sunset-times` |
| Golang | `github.com/voxgig-sdk/sunset-times-sdk/go` | `go get github.com/voxgig-sdk/sunset-times-sdk/go` |
| Ruby | `voxgig-sdk-sunset-times` | `gem install voxgig-sdk-sunset-times` |
| Lua | `voxgig-sdk-sunset-times` | `luarocks install voxgig-sdk-sunset-times` |
