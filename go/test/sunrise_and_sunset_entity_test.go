...
func TestSunriseAndSunsetEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		sunriseAndSunsetRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.sunrise_and_sunset")))
...
func sunrise_and_sunsetBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("SUNSET_TIMES_TEST_SUNRISE_AND_SUNSET_ENTID")
	...
	idmapResolved := core.ToMapAny(env["SUNSET_TIMES_TEST_SUNRISE_AND_SUNSET_ENTID"])
