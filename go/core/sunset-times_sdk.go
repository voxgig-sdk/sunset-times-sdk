...
func (sdk *SunsetTimesSDK) OptionsMap() map[string]any {
...
func (sdk *SunsetTimesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *SunsetTimesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *SunsetTimesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SunsetTimesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *SunsetTimesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *SunsetTimesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("SunsetTimesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *SunsetTimesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SunsetTimesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("SunsetTimesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
