...
func NewSunriseAndSunsetEntity(client *core.SunsetTimesSDK, entopts map[string]any) *SunriseAndSunsetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SunriseAndSunsetEntity) GetName() string { return e.name }
...
func (e *SunriseAndSunsetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SunriseAndSunsetEntity) Deleted() bool {
	return e.deleted
}


func (e *SunriseAndSunsetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSunriseAndSunsetEntity(e.client, opts)
}

func (e *SunriseAndSunsetEntity) Data(args ...any) any {
...
func (e *SunriseAndSunsetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *SunriseAndSunsetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SunriseAndSunsetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SunriseAndSunsetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SunriseAndSunsetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SunriseAndSunsetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SunriseAndSunsetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
